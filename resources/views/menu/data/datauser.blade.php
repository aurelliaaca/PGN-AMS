                            ...
                            <div style="display: flex; gap: 20px;">
                                <div style="width: 48%;">
                                    ...
                                    <input type="text" name="perusahaan"
                                        value="{{ old('perusahaan', $user->perusahaan) }}" class="form-control" required>
                                ...
                                <div style="width: 48%;">
                                    ...
                                    <select name="role" class="form-control" required>
                                        ...
                                        <option value="2" {{ old('role', $user->role) == 2 ? 'selected' : '' }}>Operator Aset</option>
                                        <option value="3" {{ old('role', $user->role) == 3 ? 'selected' : '' }}>Pengguna Region</option>
                                        <option value="4" {{ old('role', $user->role) == 4 ? 'selected' : '' }}>Pengguna Internal</option>
                                        <option value="5" {{ old('role', $user->role) == 5 ? 'selected' : '' }}>Pengguna Eksternal</option>
                                    </select>
